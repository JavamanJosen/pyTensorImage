...
#tf.app.flags.DEFINE_integer('charset_size', 3835, "Choose the first `charset_size` characters only.")
tf.app.flags.DEFINE_integer('charset_size', 3831, "Choose the first `charset_size` characters only.")
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        for i in range(len(final_reco_text)):
            result = result + final_reco_text[i]
